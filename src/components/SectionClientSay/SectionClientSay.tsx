...
const DEMO_DATA = [
  {
    ...
    content:
      "Productos excepcionales, precios asequibles, entrega rápida y un servicio amigable. Definitivamente los recomiendo.",
  },
  {
    id: 2,
    clientName: "Lennie Swiffan",
    content:
      "Calidad superior en productos, precios accesibles, entrega rápida y un servicio amigable. Sin duda, los recomendaría.",
  },
  {
    id: 3,
    clientName: "Berta Emili",
    content:
      "Productos de alta calidad, precios asequibles, entrega rápida y un servicio amigable. Definitivamente los aconsejo.",
  },
];
...
const SectionClientSay: FC<SectionClientSayProps> = ({ className = "" }) => {
  ...
  return (
    ...
    >
      <Heading desc="Veamos qué piensan las personas sobre Ciseco" isCenter>
      Buenas noticias desde lejos 🥇
      </Heading>
