...
const DATA_sortOrderRadios = [
  { name: "Más Popular", id: "Most-Popular" },
  { name: "Mejor Calificación", id: "Best-Rating" },
  { name: "Más Reciente", id: "Newest" },
  { name: "Precio Bajo - Alto", id: "Price-low-hight" },
  { name: "Precio Alto - Bajo", id: "Price-hight-low" },
];
...
const SidebarFilters = () => {
  ...
  const renderTabsColor = () => {
    return (
      <div className="relative flex flex-col py-8 space-y-4">
        <h3 className="font-semibold mb-2.5">Colores</h3>
  ...
  const renderTabsSize = () => {
    return (
      <div className="relative flex flex-col py-8 space-y-4">
        <h3 className="font-semibold mb-2.5">Tallas</h3>
        {DATA_sizes.map((item) => (
          <div key={item.name} className="">
            <Checkbox
              name={item.name}
    ...
    return (
      <div className="relative flex flex-col py-8 space-y-5 pr-3">
        <div className="space-y-5">
          <span className="font-semibold">Rango de precios</span>
          <Slider
            range
            min={PRICE_RANGE[0]}
            max={PRICE_RANGE[1]}
  ...
  return (
    <div className="divide-y divide-slate-200 dark:divide-slate-700">
      ...
      <div className="py-8 pr-2">
        <MySwitch
          label="On sale!"
          desc="Productos actualmente en oferta"
          enabled={isOnSale}
